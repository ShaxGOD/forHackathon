...
export default function RegistrationThird({ navigation }) {
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.card}>
                    ...
                    <DatePicker />
                    <Input style={styles.input} placeholder={'Город'} />
                    <Input style={styles.input} secureTextEntry placeholder={'Район'} />
                    <Input style={styles.input} secureTextEntry placeholder={'Должность'} />
